...
Le WI est la seule source de vérité pour un chantier. Les agents (Claude, Codex, Arnaud) y lisent le `Status` et exécutent une seule phase à la fois selon le contrat `ai-system/AI_SYSTEM.md`.
